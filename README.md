# 🧙‍♂️ Cahem Web Tasarım Kursları
Bu GitHub deposu, Ankara Çankaya Halk Eğitim Merkezi'nde aldığım web tasarım eğitimleri süresince edindiğim kapsamlı bilgi birikimini ve geliştirdiğim pratik projeleri bir araya getiren kişisel bir portfolyo niteliğindedir. Bu repoyu oluşturmaktaki temel amacım, kurs boyunca tuttuğum detaylı notları düzenli bir şekilde saklamak ve öğrendiğim teorik bilgileri somut çıktılara dönüştürdüğüm web tasarım projelerimi sergilemektir.

Burada, HTML'in yapısal temellerinden CSS'in görsel biçimlendirme gücüne, duyarlı (responsive) tasarım prensiplerinden modern web standartlarına kadar birçok konuda yaptığım çalışmaları bulabilirsiniz. Her bir proje, edindiğim bilgi ve becerilerin pratik uygulamasını temsil ederken, notlar da bu projelerin arkasındaki öğrenme sürecini ve teorik alt yapıyı detaylandırmaktadır. Bu depo, hem kendi öğrenme yolculuğumu belgelemem hem de web tasarım alanındaki yetkinliklerimi gösterebilmem için değerli bir kaynak teşkil etmektedir.
